...
(function (Lightning) {
    var KeyboardManager = (function () {
        ...
        KeyboardManager.prototype.bindWindowKeyEvents = function () {
        ...
        KeyboardManager.prototype.key = function (keyCode) {
            return this._keys[keyCode];
        };
        KeyboardManager.prototype.findKey = function (code) {
        ...
        KeyboardManager.prototype.createKeys = function () {
            var keyPairs = [];
            ...
            for (var _i = 0, keyPairs_1 = keyPairs; _i < keyPairs_1.length; _i++) {
                var keyData = keyPairs_1[_i];
                var key = new Lightning.Key(keyData.ascii, keyData.alias);
                this._keys[keyData.alias] = key;
            }
        };
        return KeyboardManager;
    }());
    Lightning.KeyboardManager = KeyboardManager;
})(Lightning || (Lightning = {}));
