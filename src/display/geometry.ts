...
namespace Lightning {
    export class Geometry {
         ...
         * @returns {Lightning.Graphics}
         */
        public static Star(w:number, h:number):Lightning.Graphics {
            let graphics = new Lightning.Graphics();
            graphics.beginFill(0xffffff, 1);
            graphics.drawRect(0, 0, w, h);
            graphics.endFill();
         ...
         * @returns {Lightning.Graphics}
         */
        public static Rect3D(w:number, h:number, d:number):Lightning.Graphics {
            w *= 2, h *=2, d *= 2;
            let graphics = new Lightning.Graphics();
            // draw front
            graphics.beginFill(0xffffff, 1);
         ...
         * @returns {Lightning.Graphics}
         */
        public static Circle(r:number):Lightning.Graphics {
            let graphics = new Lightning.Graphics();
            graphics.beginFill(0xffffff, 1);
